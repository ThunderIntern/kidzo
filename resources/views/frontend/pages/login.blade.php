	...
	{!! Form::open(['url' => route('login' , ['id' => $page_datas->datas])]) !!}
		...
		<button class="btn btn-success mbottom-s pull-right" type="submit">Log In</button>
		<a href="{{route('forgot' , ['id' => $page_datas->datas])}}" class="pull-left"><b>Forgot Password</b></a></br></br>
		
		<a href="{{route('create' , ['id' => $page_datas->datas])}}" class="pull-left"><b>Create Account</b></a>
