	...
	<div class="container">
		<div class="col-md-12 col-sm-12">
			<div class="col-md-3 col-sm-3 borderRight1" style="min-height: calc(95vh)">
				...
				<a href="{{Route('katalog' , ['no' => '0'])}}"><h5 class="mleft-s black">Semua</h5></a>
				<a href="{{Route('katalog' , ['no' => '1'])}}"><h5 class="mleft-s black">0 - 1 Tahun</h5></a>
				<a href="{{Route('katalog' , ['no' => '2'])}}"><h5 class="mleft-s black">1 - 2 Tahun</h5></a>
				<a href="{{Route('katalog' , ['no' => '3'])}}"><h5 class="mleft-s black">2 - 3 Tahun</h5></a>
				<a href="{{Route('katalog' , ['no' => '4'])}}"><h5 class="mleft-s black">3 Tahun Keatas</h5></a>
			</div>
