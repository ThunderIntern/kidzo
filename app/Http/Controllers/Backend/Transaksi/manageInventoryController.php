...
class manageInventoryController extends BaseController
{
    ...
    public function store($id = null)
    {
        ...
        if($input['password'] != $input['conf_password']){
            ...
            return $this->generateRedirect(route('backend.transaksi.manageInventory.store'));
        }
        //save data
        $Inventory->email                           = $input['email'];
        $Inventory->username                        = $input['username'];
        $Inventory->password                        = $input['password'];
